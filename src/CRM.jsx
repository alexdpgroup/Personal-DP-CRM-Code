...
function LPDetailDrawer({ lp, fundMOICs, partners, onClose, onSave, onUpdateCommitment, onDelete, onPortal }) {
  ...
  const totalNAV = commitments.filter(c => c.stage === 'closed').reduce((s, c) => s + calcCommitmentNAV(c.commitment, c.fund, moics), 0);
      ...
      <div className="portal-content fade-in">
        ...
        <div className="portal-grid">
          ...
          <div className="portal-card">
            ...
            <div className="portal-row"><span className="lbl">Unfunded Capital</span><span className="val">{fmtMoney(totalCalled - totalFunded)}</span></div>
          </div>
                  ...
                  {allInvestments.map(inv => {
                    ...
                    return (
                      <tr key={inv.id} onClick={() => setSelectedLP(inv)}>
                        ...
                        {(() => { const invNAV = inv.stage === 'closed' ? calcCommitmentNAV(inv.commitment, fundName, fundMOICs) : 0; return (
